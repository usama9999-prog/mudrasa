                ...
                <form id="addStudentForm" method="POST" action="{{ route('students.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="class" id="student_class" class="form-control" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="tarbiti_nisab_khuangi" id="tarbiti_nisab_khuangi" class="form-control">
                            <div class="invalid-feedback" id="error-tarbiti_nisab_khuangi"></div>
                        </div>
